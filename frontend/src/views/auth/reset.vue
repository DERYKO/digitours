                        ...
                        <div class="nk-block nk-block-middle nk-auth-body">
                            <div class="brand-logo pb-5">
                                <router-link to="/dashboard" class="logo-link">
                                    <img class="logo-light logo-img logo-img-lg" src="../../assets/logo.png" alt="logo">
                                    <img class="logo-dark logo-img logo-img-lg" src="../../assets/logo-dark.png"
                                         alt="logo-dark">
                                </router-link>
                            </div>
                            ...
                            <form @submit.prevent="resetPassword">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="default-01"
                                           placeholder="Enter your email address" required v-model="email">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-note-s2 pt-5">
                                <router-link to="/login"><strong>Return to login</strong></router-link>
                            </div>
                        </div><!-- .nk-block -->
                        ...
                        <div class="w-100 w-max-550px p-3 p-sm-5 m-auto">
                            <div class="nk-feature nk-feature-center">
                                <div class="nk-feature-img">
                                    <img class="round" src="../../assets/slides/promo-a.png" alt="">
                                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions({
                sendResetPasswordLink: 'profile/sendResetPasswordLink'
            }),
            resetPassword() {
