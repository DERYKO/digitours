        ...
        <div v-show="filters_visible===true" class="row">
            <div class="col-sm-12">
                <form class="gy-3">
                        ...
                        <div class="col-lg-7">
                            <div class="form-group">
                                <el-checkbox-group id="activities" v-model="filters.sub_activities">
                                    <el-checkbox-button v-for="activity in sub_activities" :label="activity.id" :key="activity.id">{{activity.name}}</el-checkbox-button>
                                </el-checkbox-group>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <button @click="filterDestinations" class="btn btn-primary col-sm-12 justify-content-center" type="button">Filter</button>
                    </div>
                </form>
            </div>
        </div>
